...
//              1.1.1.1 REGLE DE VALIDATION "Avoir fait TN09 et TN10"
                ...
                QList<UV*> l1 ; l1 <<  uv15 << uv14 ;               // TODO NICO: code sale, prendre le UVmanager
                ValidationRule* Stages = new XUVParmi(2, l1 ,"Avoir fait TN09 et TN10");
...
*/
        ...
        //CURSUSEditor fenetre(ALL_CURSUS,0);
        dataBase db;
        CURSUSEditor fenetre(db.getSavedAdministrationCursusTree(),0);
        fenetre.show();
        CURSUSSelector fenetre2(db.getSavedAdministrationCursusTree(),0);
        fenetre2.show();
    ...
    //TODO NICO: tous les delete sur les pointeurs :p
}
